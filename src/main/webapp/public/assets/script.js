...
$(function() {
	 ...
	 * data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1"><div
	 * class="sl-slide-inner bg-1"><div class="sl-deco" data-icon="t"></div><h2>some
	 * text</h2><blockquote><p>bla bla</p><cite>Margi Clarke</cite></blockquote></div></div>');
