			...
			<div class="row register">
				<div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
					...
					<form method="POST" action="register">
						...
						<div class="form-group row">
							<div class="col-lg-6">
								<label for="role">Choose your role</label> <select class="form-control" id="role" name="role"
									required="required">
						...
						<div class="form-group">
							<input type="text" class="form-control" type="phone" placeholder="Enter Phone number" name="phone"
								required="required">
						</div>
						<div class="form-group">
